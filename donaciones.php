...
<head>
    ...
    <style>
        ...
        .donation-card.comida-rapida {
            border-left: 4px solid #f59e0b;
            background: linear-gradient(135deg, #fffbeb, #ffffff);
        }

        .donation-card.proteinas {
            border-left: 4px solid #ef4444;
            background: linear-gradient(135deg, #fef2f2, #ffffff);
        }

        .donation-card.vegetales {
            border-left: 4px solid #10b981;
            background: linear-gradient(135deg, #ecfdf5, #ffffff);
        }

        .donation-card.frutas {
            border-left: 4px solid #8b5cf6;
            background: linear-gradient(135deg, #f5f3ff, #ffffff);
        }

        .donation-card.lacteos {
            border-left: 4px solid #3b82f6;
            background: linear-gradient(135deg, #eff6ff, #ffffff);
        }

        .donation-card.cereales {
            border-left: 4px solid #f97316;
            background: linear-gradient(135deg, #fff7ed, #ffffff);
        }

        .donation-card.bebidas {
        ...
        @media (max-width: 768px) {
            ...
            .filter-options {
                ...
                /* Estilos para el botón de agarrar donación */
        .btn-tomar-donacion {
        ...
        .btn-tomar-donacion:disabled:hover,
        .btn-tomar-donacion.disabled:hover {
            background: #9ca3af;
            transform: none;
            box-shadow: none;
        ...
        .btn-tomar-donacion span {
            font-size: 16px;
        }

        .donacion-tomada-info {
            background: #f0f9ff;
        ...
        .donacion-tomada-info strong {
            color: #0369a1;
        }

        .donacion-tomada-info p {
            margin: 4px 0;
            line-height: 1.4;
        }

        .donacion-tomada-info .fecha-info {
            font-size: 12px;
            color: #6b7280;
            margin-top: 4px;
        }

        /* Estilo para donaciones tomadas */
        .donation-card.tomada {
            position: relative;
            border-left: 4px solid #ef4444;
        }
        ...
        /* Ajustes para las tarjetas de donación */
        .donation-actions {
            margin-top: 15px;
            padding-top: 15px;
        ...
        /* Botón de liberar donación */
        .btn-liberar-donacion {
            background: #f59e0b;
            color: white;
            border: none;
            padding: 8px 16px;
        ...
        .btn-liberar-donacion:hover {
            background: #d97706;
        }

        /* Indicador de quién tomó la donación */
        .usuario-tomo-indicador {
            display: flex;
            align-items: center;
            gap: 8px;
            margin-top: 8px;
        ...
        .usuario-tomo-indicador span:first-child {
            color: #6b7280;
        }

        .usuario-tomo-indicador strong {
            color: #374151;
        }
    </style>
</head>
